...
//  Nov 27, 2023    -   Update The adjust temperature
    public static ColorFilter adjustTemperatureUpdate(float progress) {
        ColorMatrix cm = new ColorMatrix();

        // Calculate temperature values based on progress
        int r = calculateTemperatureRed(progress);
        int g = calculateTemperatureGreen(progress);
        int b = calculateTemperatureBlue(progress);

        // Apply temperature adjustment
        adjustTemperatureUpdate(cm, r, g, b);

        return new ColorMatrixColorFilter(cm);
    }

    private static void adjustTemperatureUpdate(ColorMatrix cm, int r, int g, int b) {
        // Your existing temperature adjustment logic
        cm.set(new float[]{
                r / 255.0f, 0, 0, 0, 0,
                0, g / 255.0f, 0, 0, 0,
                0, 0, b / 255.0f, 0, 0,
    ...
    private static int calculateTemperatureRed(float progress) {
        // Calculate red component based on progress
        // Adjust this calculation based on your specific requirements
        return (int) (progress * 2.55); // Assuming progress is in the range 0-100
    }

    private static int calculateTemperatureGreen(float progress) {
        // Calculate green component based on progress
        // Adjust this calculation based on your specific requirements
        return 255; // You may need to adjust this based on your requirements
    }

    private static int calculateTemperatureBlue(float progress) {
        // Calculate blue component based on progress
        // Adjust this calculation based on your specific requirements
        return (int) ((100 - progress) * 2.55); // Assuming progress is in the range 0-100
    }
